...
export function setupGeometry(scene: THREE.Scene){
  ...
  var sphereGeometry = new THREE.SphereGeometry( 30/300, 9, 4 );
  var planeGeometry = new THREE.PlaneGeometry( 500/300, 500/300 );
  var boxGeometry = new THREE.BoxGeometry( 100/300, 200/300, 150/300 );
